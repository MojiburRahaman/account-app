...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
                        ...
                        <form action="{{ route('depotwisetotalsearch') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-3">
            ...
            {{-- <section class="invoice"> --}}
                ...
                <div class="row">
                    @if (url()->current()== route('depotwisetotalsearch'))
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @isset($order->payment_sum_amount)
                                    <td>{{ $order->payment_sum_amount }}</td>
                                    @endisset
                                    @php
                                          $totall += $order->payment_sum_amount;
                                    @endphp
                                </tr>
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    {{-- @isset($totall ) --}}
                                    <td colspan="10"><h6 style="font-weight: 700;">Total ammount: {{ $totall  }}</h6></td>
                                    {{-- @endisset --}}
                                </tr>
