...
active
@endsection
@section('Paymentmethod_view-active')
active
@endsection
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Paymentmethod Index</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="col-12">
                <form action="{{route('MarkdeleteMethod')}}" method="post">
                    @csrf
                        ...
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    @if (auth()->user()->can('Delete Paymentmethod') || auth()->user()->can('Edit Paymentmethod'))
                ...
                <form action="{{route('payment-method.destroy',$item->id)}}" method="post">
                   ...
                   {{-- <td>
                    ...
                    <td>
                        ...
                        <a style="padding: 7px 8px" href="{{route('payment-method.edit',$item->id)}}"
